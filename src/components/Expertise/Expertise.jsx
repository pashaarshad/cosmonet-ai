  ...
  return (
    <section id="expertise" className="expertise section-padding">
      <div className="container">
        <span className="section-label section-label--light">What's Our Expertise</span>
        ...
        <p className="section-body section-body--light" data-aos="fade-up" data-aos-delay="100">
          ...
          visionary concepts and production-ready reality through deep technical expertise and industry-specific mastery.
        </p>
